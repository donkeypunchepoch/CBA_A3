...
Parameters:
    ...
    _enabledFor  - Where this setting can be applied. (optional, default: ["client", "server", "mission"]) <ARRAY>
...
GVAR(defaultSettings) setVariable [_setting, [_defaultValue, _setting, _settingType, _settingData, _category, _displayName, _tooltip, _enabledFor, _script]];
